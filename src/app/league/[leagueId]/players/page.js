...
export default function PlayersPage() {
  ...
  const preCheckAddPlayer = async (player) => {
    ...
    try {
      ...
      console.log(`[PreCheck] Foreigner On-Team Limit: ${onTeamLimit}`);
      ...
      if (isForeigner) {
        ...
        console.log(`[PreCheck] Adding Foreigner. Current Count: ${currentForeigners}. New Count: ${currentForeigners + 1}`);
